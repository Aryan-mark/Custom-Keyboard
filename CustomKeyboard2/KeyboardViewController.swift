...
//  CustomKeyboard2
//
//  Created by Aryan Jaiswal on 29/12/25.
//
import UIKit
import SwiftUI
...
class KeyboardViewController: UIInputViewController {
    ...
    private var hostingController: UIHostingController<KeyboardView2>?

    override func viewDidLoad() {
        super.viewDidLoad()

        // Create a hosting controller to embed SwiftUI views
        let keyboardView = KeyboardView2(onKeyPress: { [weak self] key in
            self?.insertText(key)
        })
